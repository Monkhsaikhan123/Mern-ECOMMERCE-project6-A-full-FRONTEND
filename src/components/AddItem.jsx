    ...
    const onSubmit = async (data) => {
        ...
        const hostingImage = await axiosPublic.post(image_hosting_api, imageFile, {
          ...
          if(hostingImage.data.success){
             ...
             const postMenuItem = axiosBaseURL.post('/menu2', menuItem)
    ...
    <div className='w-2/3 h-screen'>
                                    <form onSubmit={handleSubmit(onSubmit)}>
                                            ...
                                            <div className="form-control w-full my-6">
                                                ...
                                                <input type="text" {...register("name", { required: true })} placeholder="Item name" className="input input-bordered w-full" />
                                            </div>
                                            ...
                                            <div className='flex items-center gap-4'>
                                                <div className="form-control w-full max-w-xs">
                                                    ...
                                                    <select  {...register("category", { required: true })} className="select select-bordered">
                                                        ...
                                                        <option value='Хөдөө аж ахуйн агрегат'>Хөдөө аж ахуйн агрегат</option>
                                                        <option value='Хүлэмжний хэрэгсэл'>Хүлэмжний хэрэгсэл</option>
                                                        <option value='Гар багаж хэрэгсэл'>Гар багаж хэрэгсэл</option>
                                                        <option value='Усалгааны хэрэгсэл'>Усалгааны хэрэгсэл</option>
