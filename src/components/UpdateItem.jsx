...
const UpdateItem = () => {
    ...
    const onSubmit = async(data) => {
        ...
        if(hostingImage.data.success){
            ...
            const postProductItem = axiosPublic.patch(`/menu2/${editproduct._id}`, blogItem)
    ...
    useEffect((e)=>{
        axios.get('http://localhost:3000/menu2/'+ id)
        .then(res=>{
    ...
    <div>
        ...
        <div className='w-full bg-white flex justify-center items-center'>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="mx-auto w-full h-full flex bg-white flex-col items-center relative">
                                <h1 className='text-4x1 font-bold tracking-tight text-gray-900 dark:text-white'>UPDATE <span className='text-green'>ITEM</span></h1>
